    ...
    <div>
      ...
      <section className="bg-gray-50 reveal">
        <div className="max-w-4xl mx-auto px-6 py-10">
          ...
          <div className="bg-white border-l-4 border-[#022444] p-4 rounded-r text-sm mt-4 text-gray-700">
            <strong>Uwaga:</strong> Oplata &pound;20 jest pobierana w momencie
      ...
      <section className="bg-white reveal">
        <div className="max-w-4xl mx-auto px-6 py-10">
          ...
          <p className="text-gray-600 leading-relaxed">
            &pound;20 to okolo 100 PLN (w zaleznosci od aktualnego kursu wymiany).
      ...
      <section className="bg-white reveal">
        <div className="max-w-4xl mx-auto px-6 py-10">
          ...
          <p className="text-gray-600 leading-relaxed">
            Nie. Oplata &pound;20 dotyczy wszystkich wnioskodawcow, niezaleznie
